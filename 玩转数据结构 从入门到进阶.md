...
![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-29-39.png)
...
2. 什么是线段树
   ...
   ![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-30-28.png)

   以求和为例：根节点存储的是整个区间的和，A[0...3]存储的是0-3这个区间的和，A[4...7]存储的是4-7这个区间的和。如果要求3-5这个区间的和，那么只需把A[3]和A[4...5]这两个节点加起来就行。

### 9-2 线段树基础表示

![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-30-58.png)
...
![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-31-37.png)

我们的线段树不考虑添加元素，即区间固定，使用4n的静态空间即可。

例如区间里有5个元素：

![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-32-09.png)
...
1. 什么是字典树（前缀树，Trie）
   ...
   ![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-32-45.png)
...
如图所示，5、6、7属于一个集合，1、2、3属于一个集合，如果要合并3和7所属的集合，只需将7所在的树的根节点，也就是5指向2即可。

![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-28-45.png)
...
2. 基于rank的优化
   ...
   ![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-33-36.png)
...
3. 路径压缩
   ...
   ![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-34-09.png)
...
![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-34-44.png)
...
![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-35-22.png)
...
* 节点可以存放一个元素（2个孩子）或者两个元素（3个孩子）
  ...
  ![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-35-50.png)

  * 2节点：存放1个元素，和二分搜索树一样

  * 3节点：存放2个元素，左子树小于b，右子树大于c，中间的子数介于b和c之间。

    ![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-51-02.png)
...
![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-51-31.png)

再把4节点拆解

![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-52-02.png)

此时不是一颗平衡树，所以拆解后的子数的根节点12要向父节点融合。

![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-52-32.png)

再添加元素11，于是就和6融合形成6-11的3节点，再来一个节点5，融合成5-6-11的4节点，4节点拆分，节点6和12-37节点融合形成6-12-37的4节点，

![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-53-03.png)

把4节点拆分，

![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-53-55.png)

### 13-3 红黑树与2-3树的等价性

在红黑树上，用这样两种方式表示2-3树中的2节点和3节点

![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-54-26.png)
...
![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-54-56.png)
...
- 根节点是黑色的
  ...
  由2-3树可知，根节点要么是2节点要么是3节点，不管是2节点还是3节点对应的红黑树的根节点都是黑色的。
...
* 向红黑树中的”2-node“节点添加元素
  * 在红黑树中添加一个值37，要添加的值在红黑树的左侧，此时不需要做别的工作。![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-55-21.png)
  ...
  * 在红黑树中添加一个值42，要添加的值在红黑树的右侧，此时不满足红黑树的定义（红黑树的红色节点都是偏左的），需要进行左旋转。
    ...
    * ```// 因为是2节点，所以node节点的起始颜色肯定是黑色的```
      ...
      ![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-55-51.png)
...
* 向红黑树中的”3-node“节点添加元素
  ...
  * 如下图，在37-42这个红黑树中添加元素66，在2-3树中会短暂地融合成一个4节点，然后拆分成3个2节点，对应在红黑树中，应该是3个黑色的节点。然后此时42节点要和它们之前的父节点进行融合，融合意味着42节点要变成红节点。
    ...
    ![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-56-31.png)
  ...
  * 如下图，在37-42这个红黑树中添加新节点12， 此时会进行右旋转。
    ...
    * ```node.color = RED;    //表示要和父节点融合在一起```
    ...
    ![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-57-19.png)

  * 在37-42这个红黑树中添加元素37

    ![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-58-11.png)

  * **这三种情况总结下来就是**：

    ![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-58-44.png)
...
![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2019-02-13_10-41-00.png)

>  对于2节点，左旋和右旋都可以。

2-3-4树添加元素的过程

![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2019-02-13_11-05-33.png)

**注意**：最后一步添加 X 时，CER 节点必须要分裂，因为2-3-4树在查找插入点时，若遇到满节点，就必须分裂，如果CER不分裂的话，可以想一下继续添加 Y 和 Z后的场景。
...
在计算机中都是32位或者54位的二进制表示，只不过计算机解析成了浮点数。可以把32或者64位空间当作一个大整数来处理
...
1. **一致性**：如果a==b，则```hash(a) == hash(b)```，但反过来不一定成立。
2. **高效性**：计算高效简便
3. **均匀性**：哈希值均匀分布
...
![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-59-19.png)
...
![](http://sherry-pic.oss-cn-hangzhou.aliyuncs.com/markdown_2018-11-07_21-59-46.png)
...
* Coalesced Hashing：综合了Seperate Chaining和Open Address两种方法。
